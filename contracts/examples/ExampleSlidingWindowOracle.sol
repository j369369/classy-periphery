...
import "../libraries/ClassySwapOracleLibrary.sol";
...
contract ExampleSlidingWindowOracle {
    ...
    function update(address tokenA, address tokenB) external {
        ...
        if (timeElapsed > periodSize) {
            ...
            ) = ClassySwapOracleLibrary.currentCumulativePrices(pair);
    ...
    function consult(
        ...
        address pair = ClassySwapLibrary.pairFor(factory, tokenIn, tokenOut);
        ...
        (address token0, ) = ClassySwapLibrary.sortTokens(tokenIn, tokenOut);
